/**
 * Aurora TUTORING (ENRICHMENT) — copied verbatim from api/ai/tutor.ts
 * on 2026-05-23.
 *
 * Companion to aurora-tutoring-core.ts. This is the ENRICHMENT block
 * — the second prompt that adds Jordanian-uni specific intelligence,
 * subject-deep strategies, and other contextual teaching guidance on
 * top of the core.
 *
 * Same separation contract as the core file: edits here ONLY affect
 * Aurora. basudrus.com is unaffected.
 *
 * NOTES FOR EDITING
 *  - This block has the most market-specific content (Jordanian
 *    universities, Arabic linguistics, local academic culture). If
 *    Aurora is meant for a different audience or for international
 *    expansion, this is where you'd swap out.
 *  - Adds ~777 lines to every Aurora call. Same cost-pruning advice
